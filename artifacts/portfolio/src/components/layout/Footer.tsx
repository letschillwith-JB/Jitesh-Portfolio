          ...
          <div>
            ...
            <div className="flex flex-col gap-3 text-sm text-muted-foreground">
              ...
              <a
                ...
                className="hover:text-primary transition-colors w-fit"
              >
                Jiteshbabani808@gmail.com
              </a>
              <a
                href="https://wa.me/919165759300"
                target="_blank"
                rel="noreferrer"
                className="hover:text-secondary transition-colors w-fit flex items-center gap-2"
                style={{ color: "inherit" }}
              >
                <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor" className="text-secondary shrink-0">
